...
export default function Navbar() {
  const { t } = useTranslation(); // only need t() here
  ...
  const changeLanguage = (lng) => {
    i18n.changeLanguage(lng); // ✅ use imported i18n
    ...
    <header className="w-full bg-white border-b border-gray-200 dark:border-neutral-700 z-50 text-black">
      ...
      <nav className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-2">
        <div className="flex items-center justify-between py-3">
          ...
          <img src="/assests/images/weblogo.png" alt="" 
          width={140}
          
          
          />
            {/* <span className="text-xl font-semibold dark:text-black">  </span> */}
          </Link>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="hidden md:flex items-center gap-3" ref={dropdownRef}>
              ...
              <div className="relative">
                <button
                  ...
                  className="px-3 py-2 text-sm flex items-center gap-2 text-gray-800 hover:bg-gray-50 rounded-lg dark:text-black dark:hover:text-white dark:hover:bg-[#A31D1D]"
                >
                  {t('dopdown')}
                ...
                {dropdownOpen && (
                  <div className="absolute mt-2 w-52 bg-white dark:bg-neutral-800 border border-gray-100 dark:border-neutral-700 rounded-lg shadow-lg z-40">
                    <ul className="py-1">
                      <li>
                        <Link href="#" className="block px-3 py-2 text-sm hover:bg-gray-50 dark:hover:bg-neutral-700">About</Link>
                      </li>
                      <li className="relative">
                        <button
                          onClick={() => setSubmenuOpen((s) => !s)}
                          className="w-full text-left px-3 py-2 text-sm flex items-center justify-between hover:bg-gray-50 dark:hover:bg-neutral-700"
                        >
                          <span>Sub Menu</span>
            ...
            <div className="relative" ref={langRef}>
              ...
              {langOpen && (
                <div className="absolute right-0 mt-1 w-36 bg-white dark:bg-[#A31D1D] border text-white border-gray-100 dark:border-neutral-700 rounded-md shadow-lg z-40">
            ...
            <div className="md:hidden" ref={menuRef}>
              <button
                ...
                className="p-2 rounded-md border border-gray-200 text-gray-700 dark:text-black dark:border-neutral-700"
              >
